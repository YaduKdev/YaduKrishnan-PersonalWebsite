        ...
        <div className="bg-white text-black py-16 lg:py-20">
          <div className="main-container grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="flex items-center">
              <p className="text-lg lg:text-xl leading-relaxed">HTML, CSS, Javascript, React JS / Angular, Redux / NgRX, Motion, MUI / Material UI / Shadcn / Bootstrap, SASS, Tailwind CSS</p>
            </div>
          </div>
        </div>
        ...
        <div className="py-16 lg:py-20">
          <div className="main-container grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="flex gap-6 lg:gap-8">
              ...
              <h2 className="text-[8vw] md:text-6xl font-heading font-bold leading-none">Others</h2>
            </div>
            <div className="flex items-center">
