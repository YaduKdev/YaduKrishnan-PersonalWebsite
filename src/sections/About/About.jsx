const About = () => {
  return (
    <div className='h-screen bg-white rounded-t-[60px]'>
      <div className='about-text main-container py-4 gap-3 md:gap-5 lg:py-12 h-full flex flex-col justify-center items-center font-heading text-black text-xl md:text-2xl xl:text-4xl leading-tight'>
        <p>
